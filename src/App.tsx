...
function LandingPage() {
  ...
  const faqItems: AccordionItemType[] = [
    ...
    },
    {
      ...
      answer:
        "Tomo can read your emails (coming soon, with your permission) to understand meeting context, project details, and relationships. This helps it suggest better times and locations. You control what Tomo can access.",
    },
    {
      id: "q5",
                ...
                <ul className="space-y-4">
                  ...
                  <li>
                    ...
                    <span className="text-neutral-600">
                      ...
                      and picks the moments that actually work. With optional email access (coming soon), it understands project context and relationships to make smarter suggestions.
                    </span>
                  </li>
                  <li>
            ...
            <Card className="mt-6 max-w-3xl">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="mt-3">
                  It only sees and acts on what you explicitly allow. Email access (coming soon) is optional — you choose whether to grant permission for Tomo to read emails and add context. It can't add anything to your
