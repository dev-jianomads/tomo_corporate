    ...
    >
      <div className={LEGAL_DOC_PROSE}>
        ...
        <p>
          ...
          product Settings. You can also revoke Tomo’s access at any time from
        ...
        <h2>6. Artificial intelligence, training, and model providers</h2>
        ...
        <div className="overflow-x-auto">
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  Account after deletion request (including provider-derived
                  Customer Data)
                </td>
                <td>
                  Soft-delete grace period (about <strong>30 days</strong>), then
                  hard deletion / scrubbing of active systems
                </td>
              </tr>
              <tr>
                <td>Backups</td>
                <td>Per provider backup schedules (rolling windows), then expire</td>
              </tr>
              <tr>
        ...
        <p>
          ...
          deletion at any time through product settings or by contacting us at{" "}
        ...
        <ul>
          ...
          <li>
            Customer Data — including provider-derived data synced from Google
            and Microsoft (for example email, calendar, and related content we
            stored to operate the Service) — enters a soft-delete grace period of
            about <strong>30 days</strong>, then is hard-deleted or scrubbed from
            active systems; and
          </li>
          <li>
        ...
        <p>
          Revoking access at Google or Microsoft (see Section 2.2) stops new
          API access; data already stored in TOMO is purged under this
          account-deletion process (or earlier if you request an explicit purge).
        </p>
        ...
        <p>
          ...
          version above will change when we do. Material changes will be
          communicated by email or in-product notice where appropriate. Continued
          use after the effective date means you acknowledge the updated Policy,
          except where law requires a different consent mechanism.
        </p>
